...
zen-space-routing-rulepanel-placeholder = Routes let you choose where specific sites open inside Baz. For example, you can route YouTube links to always open inside your Personal space.
